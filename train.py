...
def flash_attention(q, k, v, window_size):
    ...
    k = k.transpose(1, 2)
    v = v.transpose(1, 2)
    attn_mask = build_attn_mask(q.size(2), window_size, q.device)
...
EMBEDDING_LR = 0.61     # learning rate for token embeddings (Adam)
UNEMBEDDING_LR = 0.005  # learning rate for lm_head (Adam)
MATRIX_LR = 0.0385      # learning rate for matrix parameters (Muon)
